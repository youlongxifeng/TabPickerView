package android.image.com.tabpickerview.widget;
...
import android.image.com.tabpickerview.been.SubTab;
 ...
 * 作者：xiezhenggen on 2017/11/22 10:58
 */
...
//                    mTabPickingListener.onSelected(mSelectedIndex);
    ...
    public abstract static class TabPickerDataManager {
        ...
        public TabPickerDataManager() {
            ...
            Log.i("oschina", "Active Data Set: " + (mActiveDataSet == null ? "true" : "" + mActiveDataSet.size()));
